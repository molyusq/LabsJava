...
public class StringsController {
	...
	public StringsController(){
		...
		input.printMessage("refl2: "+(new StringsModel(new String[]{"q"}).equals(new StringsModel(new String[]{"q"}))));
		input.printMessage("refl3: "+(new StringsModel(new String[]{"q"})==new StringsModel(new String[]{"q"})));
		input.printMessage("refl4: "+(new StringsModel(new String[]{"q"}).equals(new StringsModel(new String[]{"x"}))));		
	}
}
